R Markdown文档及配套图片（Rmd文件及JCRPicture文件夹，可在Rstudio中查看与编辑）、[Python脚本](Crawler_JCR20260207.py/ "Crawler_JCR20260207.py")（纯代码）、[期刊信息txt文件](Abbreviation_JCR20260617.txt/ "Abbreviation_JCR20260617.txt")（利用本方法于 2026/6/17 从JCR网站爬取，包含22643个期刊的名称、ISO缩写和JCR缩写，可直接导入Endnote等期刊管理软件使用）已上传仓库，可按需下载。
...
-   从[ChromeDriver官网](https://developer.chrome.com/docs/chromedriver/downloads/version-selection "Version selection | ChromeDriver | Chrome for Developers")下载对应版本的Chromedriver。

未找到完全一致的版本号时，可选择主要版本号、次要版本号和内部版本号一致的chromedriver下载使用（如此处的 `122.0.6261` 一致即可）。

![](JCRPicture/2_安装WebDriver_(4).png)

此处提供几个ChromeDriver备用下载途径：

[不同版本Chrome适配的chromedriver下载链接](https://textdata.cn/blog/2025-03-24-setting-chromedriver-environment-for-selenium/ "资源 | 不同版本Chrome适配的chromedriver下载链接 | 大邓和他的PYTHON")

[夸克网盘分享](https://pan.quark.cn/s/e9e6bb564337 "来源：https://blog.csdn.net/JasonXu94")

[夸克网盘分享](https://pan.quark.cn/s/305c588b691e "来源：https://blog.csdn.net/huaisha1224")

[百度网盘分享](https://pan.baidu.com/s/1hVR7HB-K_5ZRBID23h7_Kg?pwd=2049 "来源：https://blog.csdn.net/huaisha1224")
